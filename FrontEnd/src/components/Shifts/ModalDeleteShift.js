...
import { deleteShiftsAction } from '../../actions/shiftsActions';
...
export default function ModalDelete(props) {
    ...
    const handleSubmit = e => {
        ...
        dispatch(deleteShiftsAction(props.id));
        setOpen(false);
        props.handleModal(false);
        props.handleModalUpdate(false);
    }
                    ...
                    >
                        ...
                        >
                            ...
                            <div className='d-flex justify-content-end'>
                                <button className="btn btn-primary" /*type="submit"*/ onClick={(e) => {handleSubmit(e);}}>Si</button>
